        ...
        init: function (options)
        {
            ...
            return this.each(function ()
            {
                ...
                if (!data)
                {
                    ...
                    messageHtml += "<span class='message-text' STYLE='font-size: 10pt'>" + messageText + "</span>";
                    if (options.dismiss)
                    {
                        messageHtml += "<span class='message-dismiss' STYLE='font-size: 10pt'> Haga \"Click\" para ignorar.</span>";
                    }
