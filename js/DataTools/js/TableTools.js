...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Tabla Copiada</h6>'+
				'<p>Copiada'+plural+' '+len+' fila'+plural+' al portapapeles.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Vista de Impresi\u00f3n</h6><p>Para imprimir la Tabla use la funci\u00f3n por defecto del Navegador"+
		  ".<br> Presione <strong>Esc</strong> para salir.",
		"sMessage": null,
		"bShowAll": true,
 ...
 */
TableTools.DEFAULTS = {
	"sSwfPath":        "js/DataTools/swf/copy_csv_xls_pdf.swf",
	"sRowSelect":      "none",
	"sSelectedClass":  null,
	"fnPreRowSelect":  null,
	"fnRowSelected":   null,
