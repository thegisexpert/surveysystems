            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-prepend">
                        ...
                        <input type="text" class="input-xlarge" id="name" name="name" value="<? if(isset($_GET['id'])) echo $LISTA_FC['Fc']['nombre']['0'];?>" placeholder="Grupo de Cargos" <? if (isset($_GET['view'])) echo 'disabled' ?>>
                    </div>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-prepend">
                        ...
                        <textarea class="input-xlarge" rows="3" id="desc" name="desc" placeholder="Descripci&oacute;n" <? if (isset($_GET['view'])) echo 'disabled' ?>><? if(isset($_GET['id'])) echo $LISTA_FC['Fc']['descripcion']['0'];?></textarea>
                    </div>
                </div>
            </div>
            <div class="control-group">
                    ...
                    <div class="span6">
                    <p>
                    <a class="btn btn-info" href="vListarFamiliasC.php">Listar Grupo de Cargos</a>
                    <?  if (isset($_GET['view'])) 
