	...
	?>
	  ...
	  <table align="center" cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example" width="100%">
		...
		<td class="center lsmallT" nowrap><small>
		  <a href="./vEstadisticas.php?periodo=<?echo $LISTA_EVALUACION['Proc']['id'][$i]; ?>" title="<? echo "".$LISTA_EVALUACION["Proc"]["pendiente"][$i]." de ".$LISTA_EVALUACION["Proc"]["total"][$i]." evaluaciones";?>">
		...
		<td class="center lsmallT" nowrap><small>
		  <a href="./vEstadisticas.php?periodo=<?echo $LISTA_EVALUACION['Proc']['id'][$i]; ?>" title="<? echo "".$LISTA_EVALUACION["Proc"]["en_proceso"][$i]." de ".$LISTA_EVALUACION["Proc"]["total"][$i]." evaluaciones";?>">
		    <? if ($LISTA_EVALUACION["Proc"]["total"][$i]>0){
		...
		<td class="center lsmallT" nowrap><small>
		  <a href="./vEstadisticas.php?periodo=<?echo $LISTA_EVALUACION['Proc']['id'][$i]; ?>" title="<? echo "".$LISTA_EVALUACION["Proc"]["finalizada"][$i]." de ".$LISTA_EVALUACION["Proc"]["total"][$i]." evaluaciones";?>">
		    <? if ($LISTA_EVALUACION["Proc"]["total"][$i]>0){
		...
		<td class="center lsmallT" nowrap><small>
		  <a href="./vEstadisticas.php?periodo=<?echo $LISTA_EVALUACION['Proc']['id'][$i]; ?>" title="<? echo "".$LISTA_EVALUACION["Proc"]["aprobada"][$i]." de ".$LISTA_EVALUACION["Proc"]["total"][$i]." evaluaciones";?>">
		    <? if ($LISTA_EVALUACION["Proc"]["total"][$i]>0){
      ...
      <td class="center lsmallT" nowrap><small>
        <a href="./vEstadisticas.php?periodo=<?echo $LISTA_EVALUACION['Proc']['id'][$i]; ?>" title="<? echo "".$LISTA_EVALUACION["Proc"]["rechazada"][$i]." de ".$LISTA_EVALUACION["Proc"]["total"][$i]." evaluaciones";?>">
          <? if ($LISTA_EVALUACION["Proc"]["total"][$i]>0){
		...
		<td class="center lsmallT" nowrap>
		  ...
		  <? } else { ?>
		    <a href="./vEstadisticas.php?periodo=<?echo $LISTA_EVALUACION['Proc']['id'][$i]; ?>" title="Ver estadísticas" >
		      <img src="./img/iconos/visible-16.png" style="margin-left:5px;"></a>
		    <a href="./vListarResultados.php?periodo=<?echo $LISTA_EVALUACION['Proc']['id'][$i]; ?>" title="Listar Evaluaciones" ><img src="./img/iconos/pdf-16.png" style="margin-left:5px;"></a>
		  <? } ?>		  		  
	      </td>
	      </tr>
	    <? } //cierre del for
