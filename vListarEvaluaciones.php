  ...
  ?>
	...
	<!-- Encuestas del usuario -->
	  ...
	  if ($LISTA_EVALUACION_ACTUAL['max_res']>0){
		...
		<? switch ($LISTA_EVALUACION_ACTUAL['Enc']['estado'][$i]){
		case 'Pendiente':
		  echo "<a href='../limesurvey/index.php/survey/index/sid/".$LISTA_EVALUACION_ACTUAL['Enc']['id_encuesta_ls'][$i]."/lang/es?token=".$LISTA_EVALUACION_ACTUAL['Enc']['token_ls'][$i]."' title='Realizar evaluación'><img src='./img/iconos/edit-16.png' style='margin-left:5px;'></a>";
		  ...
		  break;
		case 'En proceso': 
		  echo "<a href='../limesurvey/index.php/survey/index/sid/".$LISTA_EVALUACION_ACTUAL['Enc']['id_encuesta_ls'][$i]."/lang/es?token=".$LISTA_EVALUACION_ACTUAL['Enc']['token_ls'][$i]."' title='Continuar evaluación'><img src='./img/iconos/edit-16.png' style='margin-left:5px;'></a>";
		  if($LISTA_EVALUACION_ACTUAL['Enc']['tipo'][$i]=="evaluacion"){
		    echo "<a href='./lib/cDescargarEncuesta.php?id_encuesta_ls=".$LISTA_EVALUACION_ACTUAL['Enc']['id_encuesta_ls'][$i]."&id_fam=".$LISTA_EVALUACION_ACTUAL['Enc']['id_fam'][$i]."' title='Descargar encuesta en PDF'><img src='./img/iconos/pdf-16.png' style='margin-left:5px;'></a>"; 
		  }
		  break;  
		case 'Finalizada':
		  if($LISTA_EVALUACION_ACTUAL['Enc']['tipo'][$i]=="autoevaluacion"){
		    ...
		    echo "<a href='./lib/cDescargarRespuesta.php?token_ls=".$LISTA_EVALUACION_ACTUAL['Enc']['token_ls'][$i]."&id_encuesta_ls=".$LISTA_EVALUACION_ACTUAL['Enc']['id_encuesta_ls'][$i]."&id_fam=".$LISTA_EVALUACION_ACTUAL['Enc']['id_fam'][$i]."&action=descargar' title='Descargar resultados' ><img src='./img/iconos/pdf-16.png' style='margin-left:5px;'></a>";
		  }
		  break;
		case 'Aprobada': 
		  if($LISTA_EVALUACION_ACTUAL['Enc']['tipo'][$i]=="autoevaluacion"){
  ...
  ?>
	...
	<thead>
	  <tr>
	    ...
	    <th class="lsmallT"><small>Persona a evaluar</small></th>
	    <th class="lsmallT"><small>Estado</small></th>
	    <th class="lsmallT"><small>Retroalimentación</small></th>
	    <th class="lsmallT"><small>Acción</small></th>
	  </tr>
      </thead>
      <tfoot>
	  ...
	  if ($LISTA_EVALUACION_PASADA['max_res']>0){
		...
		case 'Finalizada':
		  if ($LISTA_EVALUACION_PASADA['Enc']['tipo'][$i]=="autoevaluacion" && $LISTA_EVALUACION_PASADA['Enc']['periodo_quejas'][$i]==TRUE){
		    echo "<a href='./vResultados.php?token_ls=".$LISTA_EVALUACION_PASADA['Enc']['token_ls'][$i]."&action=retroalimentacion' title='Hacer retroalimentación' ><img src='./img/iconos/retroalimentacion-16.png' style='margin-left:5px;'></a>"; 
		  } else if ($LISTA_EVALUACION_PASADA['Enc']['tipo'][$i]=="autoevaluacion" && $LISTA_EVALUACION_PASADA['Enc']['periodo_quejas'][$i]==TRUE && ($mes=="Diciembre" || $mes=="Enero")) {
		    ...
		    echo "<a href='./vResultados.php?token_ls=".$LISTA_EVALUACION_PASADA['Enc']['token_ls'][$i]."' title='Ver resultados' ><img src='./img/iconos/visible-16.png' style='margin-left:5px;'></a>"; 
                ...
                echo "<a href='./lib/cDescargarRespuesta.php?token_ls=".$LISTA_EVALUACION_PASADA['Enc']['token_ls'][$i]."&id_encuesta_ls=".$LISTA_EVALUACION_PASADA['Enc']['id_encuesta_ls'][$i]."&id_fam=".$LISTA_EVALUACION_PASADA['Enc']['id_fam'][$i]."&action=descargar' title='Descargar resultados' ><img src='./img/iconos/pdf-16.png' style='margin-left:5px;'></a>";
                break;
		case 'Aprobada': 
		  if ($LISTA_EVALUACION_PASADA['Enc']['tipo'][$i]=="autoevaluacion" && $LISTA_EVALUACION_PASADA['Enc']['periodo_quejas'][$i]==TRUE){
