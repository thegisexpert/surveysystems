<?php
    session_start();
    $Legend = "Historial de Evaluadores";
    include "lib/cVerEvaluadoresPersona.php";
    include "vHeader.php";
    $all = true;
?>   
...
<?php
  ...
  if ($LISTA_EVA['max_res']==0){
      if(!isAdmin())
        echo "<br><br><br><br><br><br><p class='text-center text-info'>Hasta el momento esta persona no tiene evaluadores registrados.</p><br><br><br><br><br><br>";
      else
        echo "<br><br><br><br><br><br><p class='text-center text-info'>Hasta el momento esta persona no tiene evaluadores registrados.</p><br><br><br><br><br><br>";
  }else{
  ?>
  ...
  <tfoot>
    <tr>
      ...
      <th class="lsmallT"><small>Observaciones</small></th>
          ...
          <td class="center lsmallT" nowrap><small><a href='vPersona.php?view&id=<? echo $LISTA_EVA['Eva']['id_eva'][$i];?>'> <? echo $EVA_ID[$LISTA_EVA['Eva']['id_eva'][$i]];?></a> <? if ($LISTA_EVA['Eva']['actual'][$i] == 't') echo " (actual)"; ?></small></td>
